...
import { HtmlContentSchema } from "../../../schemas/htmlcontent.schema";
            ...
            <form>
              {step === 1 ? (
                ...
                <CKEditor
                  ...
                  initData={
                    <p>
                      Este é o seu editor. Use-o para criar seus textos e postagens!
                    </p>
                  }
                />
              )}
              <div className="buttons-container">
                <button type="button" onClick={() => step===1? navigate(-1) : setStep(1) } >{step===1? 'Cancelar': 'Voltar'}</button>
